    ...
    <>
      ...
      <main className="App">
        <header className="header">
          <h1 className="title">Black Ops 7</h1>
          <h2 className="subtitle">Solve Call of Duty Black Ops 7 Zombies Easter Egg puzzles</h2>
        </header>
